...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_file', type=str, default="./dataset/inplace_edits_train_sister.txt")
    parser.add_argument('--pretrain_bert_path', type=str, default="./bert_pretrain_chinese/checkpoint-7545")
    parser.add_argument('--save_path', type=str, default="./bert_local.pth")
    parser.add_argument('--epochs', type=int, default=5)

    args = parser.parse_args()

    # Local training: initialize the BERT encoder from a pretrained
    # (MLM-pretrained) checkpoint and train the whole network on the
    # in-place edit paths of a single dataset.
    model = PassBERT()
    model.bert.from_pretrained(args.pretrain_bert_path)
    model.to('cuda')
